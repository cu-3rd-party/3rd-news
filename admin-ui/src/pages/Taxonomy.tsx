 ...
 * The taxonomy editor.
 *
 * This is the screen that makes the whole thing configurable: a new axis or a
 * new value here is immediately visible to every classifier, because they read
 * the taxonomy out of each request instead of hardcoding it.
 */
