      ...
      <form
        ...
        onSubmit={(event) => {
          ...
          void run(async () => {
            ...
            setDraft({ ...draft, name: "", base_url: "", signing_public_key: "" });
          });
        }}
      >
        <input
        ...
        />
        <input
          placeholder="публичный ключ Ed25519 (PEM)"
          value={draft.signing_public_key}
          onChange={(e) => setDraft({ ...draft, signing_public_key: e.target.value })}
        />
        <label>
          приоритет
          <input
